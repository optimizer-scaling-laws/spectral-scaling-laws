...
This package contains torch-free analysis utilities for converting submitted-run
...
- `rank_aggregation.py`: implements the submitted plotting aggregation rule.
...
submitted-run logs remain external artifacts except for tiny parser fixtures.
